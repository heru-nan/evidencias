        ...
        <Row>
          ...
          <Col xs="6">
            ...
            <Form onSubmit={this.enviarAlaBD}>
              <FormGroup>
                <Label>autores</Label>
                <Input type="text" name="autores" value={this.state.autores} onChange={this.onChange} invalid={this.state.invalidAutores} />
                <FormFeedback>{this.state.mensajeAutores}</FormFeedback>
              </FormGroup>
              <FormGroup>
                <Label>titulo</Label>
                <Input type="text" name="titulo" value={this.state.titulo} onChange={this.onChange} invalid={this.state.invalidTitulo}/>
                <FormFeedback>{this.state.mensajeTitulo}</FormFeedback>
              </FormGroup>
              <FormGroup>
                <Label>revista</Label>
                <Input type="text" name="revista" value={this.state.revista} onChange={this.onChange} invalid={this.state.invalidRevista} />
                <FormFeedback>{this.state.mensajeRevista}</FormFeedback>
              </FormGroup>
              <FormGroup>
                <Label>indexación</Label>
                <Input type="text" name="indexacion" value={this.state.indexacion} onChange={this.onChange} invalid={this.state.invalidIndexacion} />
                <FormFeedback>{this.state.mensajeIndexacion}</FormFeedback>
              </FormGroup>
              <FormGroup>
                <Label>ISSN/DOI</Label>
                <Input type= "text" name="identificador" value={this.state.identificador} onChange={this.onChange} invalid={this.state.invalidIdentificador}/>
