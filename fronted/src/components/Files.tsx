...
const dataExample: dataFiles[] =  [
    {id:1, nombre: "exel1",nombreArchivo: ".zip",idPubli: 1,idProy:1},
    {id:2, nombre: "exel2",nombreArchivo: ".rar",idPubli: 2,idProy:2},
    {id:3, nombre: "exel3",nombreArchivo: ".tar",idPubli: 5,idProy:2},
]
